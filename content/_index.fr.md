...
- title: Techniques
  items:
  - details: NodeJs, React, Typescript, Golang, PHP, Ruby, Python
...
- name: Espagnol
  level: Intermédiaire
interests:
- name: Randonnée, lecture, voyages à vélo, yoga
experience:
...
- title: Emplois de courte durée
  ...
  location: Lyon (France)
  details: J'ai travaillé comme documentaliste et opératrice de saisie. Ces emplois m'ont appris à **travailler avec rigueur, à respecter les délais et à suivre les consignes.**
  items: []
information:
- title: Interests
  details: Randonnée, lecture, voyages à vélo, yoga
---
